...
Team member's names and email addresses/ notebooks for each person:    
...
This repository uses traffic, fire and crime data from the Western Pennsylvania Regional Data Center to show the safest neighborhood, which we deemed as best in the neighborhood of Pittsburgh.  
